...
const Card = ({ title, subtitle, icon, button, children }) => {
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center max-w-sm w-full mx-auto p-4 h-[25rem] sm:h-[30rem] relative text-center"
    >
  ...
  return (
    <section id="detalles" className="py-20 bg-white text-black mb-[100px]">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="py-10 flex flex-col lg:flex-row items-center justify-center w-full gap-8 mx-auto px-4">
